        ...
        <Container style={container}>
          ...
          <Row>
            ...
            <Column style={{ width: 476 }}>
              ...
              <Text style={paragraph}>
                You recently requested to reset the password for your Groove
              ...
              <Text style={paragraph}>
                ...
                email or reply to let us know. This password reset link is only
                valid for the next 6 hours.
              </Text>
              <Text style={paragraph}>Thanks, the Groove team</Text>
            </Column>
            <Column style={spaceX}></Column>
          </Row>
          <Row>
